...
download_dir = r'\caminho\para\diretorio\de\download'
...
# Definir o diretório temporário para mover o arquivo
temp_dir = 'C:\\temp'

# Criar o diretório temporário se ele não existir
if not os.path.exists(temp_dir):
    os.makedirs(temp_dir)

# Caminho temporário do arquivo
caminho_temp_arquivo = os.path.join(temp_dir, nome_arquivo)

# Verificar se o arquivo existe antes de tentar movê-lo
if os.path.exists(caminho_arquivo):
    try:
        # Tentar mover o arquivo para o diretório temporário
        shutil.move(caminho_arquivo, caminho_temp_arquivo)
    except PermissionError:
        print("Erro: Permissão negada para mover o arquivo para o diretório temporário.")
